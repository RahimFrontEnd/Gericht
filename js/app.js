    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".gallery__slider")) new core(".gallery__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".gallery__arrow_left",
                    nextEl: ".gallery__arrow_right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1
            ...
            if (document.querySelector(".rocks__slider")) {
                const scrollSwiper = new core(".rocks__slider", {
                    ...
                    on: {
                        init: function() {
                            var customButton = document.querySelector(".page__scroll");
                            customButton.addEventListener("click", (function() {
                                scrollSwiper.slideNext();
                            }));
                        }
                    }
                });
        ...
        if (document.querySelector(".coming__digits")) document.addEventListener("DOMContentLoaded", (() => {
            ...
            const monthsVal = document.querySelector(".time-count__months .time-count__val");
            ...
            document.querySelector(".time-count__months .time-count__text");
            ...
            const timeCount = () => {
                ...
                const days = Math.floor(leftUntil / 1e3 / 60 / 60 / 24);
                const hours = Math.floor(leftUntil / 1e3 / 60 / 60) % 24;
                const minutes = Math.floor(leftUntil / 1e3 / 60) % 60;
                const seconds = Math.floor(leftUntil / 1e3) % 60;
                const months = Math.floor(leftUntil / 1e3 / 60 / 60 / 24 / 30);
                ...
                hoursText.textContent = declOfNum(hours, [ "hour", "hours", "часовhours" ]);
